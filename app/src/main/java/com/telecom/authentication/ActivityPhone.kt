...
import com.telecom.databinding.ActivityPhoneBinding
import java.util.concurrent.TimeUnit

@SuppressLint("Registered")
class ActivityPhone : AppCompatActivity(), View.OnClickListener {
    ...
    companion object {
        fun newIntent(context: Context?) = Intent(context, ActivityPhone::class.java)
